...
var appRouter = (0, trpc_1.router)({
    userList: trpc_1.publicProcedure.query(function () { return __awaiter(void 0, void 0, void 0, function () {
        var users;
    ...
    userById: trpc_1.publicProcedure.input(zod_1.z.string()).query(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        var input, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    input = opts.input;
                    return [4 /*yield*/, db_1.db.user.findById(input)];
                case 1:
                    user = _a.sent();
    ...
    userCreate: trpc_1.publicProcedure
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    input = opts.input;
                    return [4 /*yield*/, db_1.db.user.create(input)];
                case 1:
                    user = _a.sent();
                    return [2 /*return*/, user];
            }
